namespace HatchlingCompany.Data.Migrations
{
    ...
    public partial class Poredniqinit : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Employees", t => t.RecipientId)
                .Index(t => t.AuthorId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Relationships", "RecipientId", "dbo.Employees");
            DropForeignKey("dbo.Relationships", "AuthorId", "dbo.Employees");
            ...
            DropIndex("dbo.Relationships", new[] { "RecipientId" });
            DropIndex("dbo.Relationships", new[] { "AuthorId" });
